...
euler_method_1 = simulation(@Euler, g, m1, m2, L1, L2(1), theta1_init, theta1_dot, theta2_init, theta2_dot, t_step(1), duration, dampening);
euler_method_2 = simulation(@Euler, g, m1, m2, L1, L2(2), theta1_init, theta1_dot, theta2_init, theta2_dot, t_step(2), duration, dampening);

trapezoid_method_1 = simulation(@Trapezoid, g, m1, m2, L1, L2(1), theta1_init, theta1_dot, theta2_init, theta2_dot, t_step(1), duration, dampening);
trapezoid_method_2 = simulation(@Trapezoid, g, m1, m2, L1, L2(2), theta1_init, theta1_dot, theta2_init, theta2_dot, t_step(2), duration, dampening);

runge_kutta_method_1 = simulation(@RungeKutta, g, m1, m2, L1, L2(1), theta1_init, theta1_dot, theta2_init, theta2_dot, t_step(1), duration, dampening);
runge_kutta_method_2 = simulation(@RungeKutta, g, m1, m2, L1, L2(2), theta1_init, theta1_dot, theta2_init, theta2_dot, t_step(2), duration, dampening);

ode45_method_1 = simulation(@ODE45, g, m1, m2, L1, L2(1), theta1_init, theta1_dot, theta2_init, theta2_dot, t_step(1), duration, dampening);
ode45_method_2 = simulation(@ODE45, g, m1, m2, L1, L2(2), theta1_init, theta1_dot, theta2_init, theta2_dot, t_step(2), duration, dampening);
