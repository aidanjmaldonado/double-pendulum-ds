...
euler_method_1 = simulation(@euler_method, g, m1, m2, L1, L2(1), theta1_init, theta1_dot, theta2_init, theta2_dot, t_step(1), duration, dampening, normalize);
euler_method_2 = simulation(@euler_method, g, m1, m2, L1, L2(2), theta1_init, theta1_dot, theta2_init, theta2_dot, t_step(2), duration, dampening, normalize);

trapezoid_method_1 = simulation(@trapezoid_method, g, m1, m2, L1, L2(1), theta1_init, theta1_dot, theta2_init, theta2_dot, t_step(1), duration, dampening, normalize);
trapezoid_method_2 = simulation(@trapezoid_method, g, m1, m2, L1, L2(2), theta1_init, theta1_dot, theta2_init, theta2_dot, t_step(2), duration, dampening, normalize);

runge_kutta_method_1 = simulation(@runge_kutta_method, g, m1, m2, L1, L2(1), theta1_init, theta1_dot, theta2_init, theta2_dot, t_step(1), duration, dampening, normalize);
runge_kutta_method_2 = simulation(@runge_kutta_method, g, m1, m2, L1, L2(2), theta1_init, theta1_dot, theta2_init, theta2_dot, t_step(2), duration, dampening, normalize);

ode45_method_1 = simulation(@ode45_method, g, m1, m2, L1, L2(1), theta1_init, theta1_dot, theta2_init, theta2_dot, t_step(1), duration, dampening, normalize);
ode45_method_2 = simulation(@ode45_method, g, m1, m2, L1, L2(2), theta1_init, theta1_dot, theta2_init, theta2_dot, t_step(2), duration, dampening, normalize);
...
euler_method_2.animate("Initial Condition 2 - Euler Method", animation_speed, frame.ax3)
...
trapezoid_method_2.animate("Initial Condition 2 - Trapezoid Method", animation_speed, frame.ax3)
...
runge_kutta_method_2.animate("Initial Condition 2 - Runge-Kutta Method", animation_speed, frame.ax3)

ode45_method_1.theta_plot(frame.ax2)
ode45_method_1.animate("Initial Condition 1 - Initial Condition ode45 Method", animation_speed, frame.ax1)

ode45_method_2.theta_plot(frame.ax4)
ode45_method_2.animate("Initial Condition 2 - ode45 Method", animation_speed, frame.ax3)
