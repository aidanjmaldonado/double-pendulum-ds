...
function next_state =  runge_kutta(current_state, g, m1, m2, L1, L2, step)
    ...
    k1_theta1_dot = M1AA(g, m1, m2, theta1, theta1_dot, theta2, theta2_dot, L1, L2);
    k1_theta2     = theta2_dot;
    k1_theta2_dot = M2AA(g, m1, m2, theta1, theta1_dot, theta2, theta2_dot, L1, L2);

    % Calculate k2 values
    k2_theta1     = theta1_dot + (1/2) * step * k1_theta1_dot;
    k2_theta1_dot = M1AA(g, m1, m2, theta1 + (step/2) * k1_theta1, theta1_dot + (1/2) * step * k1_theta1_dot, theta2 + (1/2) * step * k1_theta2, theta2_dot + (1/2) * step * k1_theta2_dot, L1, L2);
    k2_theta2     = theta2_dot + (1/2) * step * k1_theta2_dot;
    k2_theta2_dot = M2AA(g, m1, m2, theta1 + (1/2) * step * k1_theta1, theta1_dot + (1/2) * step * k1_theta1_dot, theta2 + (1/2) * step * k1_theta2, theta2_dot + (1/2) * step * k1_theta2_dot, L1, L2);

    % Calculate k3 values
    k3_theta1     = theta1_dot + (1/2) * step * k2_theta1_dot;
    k3_theta1_dot = M1AA(g, m1, m2, theta1 + (1/2) * step * k2_theta1, theta1_dot + (1/2) * step * k2_theta1_dot, theta2 + (1/2) * step * k2_theta2, theta2_dot + (1/2) * step * k2_theta2_dot, L1, L2);
    k3_theta2     = theta2_dot + (1/2) * step * k2_theta2_dot;
    k3_theta2_dot = M2AA(g, m1, m2, theta1 + (1/2) * step * k2_theta1, theta1_dot + (1/2) * step * k2_theta1_dot, theta2 + (1/2) * step * k2_theta2, theta2_dot + (1/2) * step * k2_theta2_dot, L1, L2);

    % Calculate k4 values
    k4_theta1     = theta1_dot + step * k3_theta1_dot;
    k4_theta1_dot = M1AA(g, m1, m2, theta1 + step * k3_theta1, theta1_dot + step * k3_theta1_dot, theta2 + step * k3_theta2, theta2_dot + step * k3_theta2_dot, L1, L2);
    k4_theta2     = theta2_dot + step * k3_theta2_dot;
    k4_theta2_dot = M2AA(g, m1, m2, theta1 + step * k3_theta1, theta1_dot + step * k3_theta1_dot, theta2 + step * k3_theta2, theta2_dot + step * k3_theta2_dot, L1, L2);
