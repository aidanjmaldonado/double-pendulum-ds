% ode45_method.m
function state_array = ode45_method(g, m1, m2, L1, L2, theta1_init, theta1_dot_init, theta2_init, theta2_dot_init, t_step, duration)

    % Returns the derivatives (right-hand side of the ODE)
    function derivatives = double_pendulum_equations(~, current_state, g, m1, m2, L1, L2)
    ...
    [~, state_array] = ode45(@(t, y) double_pendulum_equations(t, y, g, m1, m2, L1, L2), time_array, initial_state);
end